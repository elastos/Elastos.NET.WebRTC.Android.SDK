...
class WebRTCBluetoothManager {
  ...
  private final WebRTCAudioManager apprtcAudioManager;
  @Nullable
  ...
  static WebRTCBluetoothManager create(Context context, WebRTCAudioManager audioManager) {
    Log.d(TAG, "create" + WebRTCUtils.getThreadInfo());
   ...
   * Note that the WebRTCAudioManager is also involved in driving this state
   * change.
   */
  public void start() {
    ThreadUtils.checkIsOnMainThread();
