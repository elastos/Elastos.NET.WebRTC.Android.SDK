...
class WebRTCProximitySensor implements SensorEventListener {
  ...
  /** Construction */
  static WebRTCProximitySensor create(Context context, Runnable sensorStateListener) {
  ...
  private WebRTCProximitySensor(Context context, Runnable sensorStateListener) {
    Log.d(TAG, "WebRTCProximitySensor" + WebRTCUtils.getThreadInfo());
  ...
  public final void onSensorChanged(SensorEvent event) {
    threadChecker.checkIsOnValidThread();
    WebRTCUtils.assertIsTrue(event.sensor.getType() == Sensor.TYPE_PROXIMITY);
