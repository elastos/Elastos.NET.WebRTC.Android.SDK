 ...
 */
public class CarrierWebrtcClient {
     ...
     */
    public CarrierWebrtcClient(Context appContext, EglBase eglBase,
...
*/
        ...
        TurnServer turnServer = CarrierClient.getInstance(context, null).getTurnServer();
