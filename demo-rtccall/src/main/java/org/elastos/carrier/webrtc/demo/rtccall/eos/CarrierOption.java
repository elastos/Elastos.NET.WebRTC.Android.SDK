package org.elastos.carrier.webrtc.demo.rtccall.eos;
...
public class CarrierOption extends Carrier.Options {

    private static final String TAG = "CarrierOption";

    public CarrierOption(String path) {
        super();
        try {
